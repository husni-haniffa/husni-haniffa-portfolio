...
const Experience = () => {
  return (
    <section id="experience" className="py-20 bg-background relative overflow-hidden">
      ...
      <div className="absolute top-20 left-10 w-40 h-40 bg-secondary/10 rounded-full opacity-20"></div>
      <div className="absolute bottom-20 right-10 w-32 h-32 bg-primary/10 rounded-full opacity-20"></div>
